...
function Header(){
	...
	$edit = 'Edit';
	$date = 'Date';
	$input = "Up colontitul (right) [$edit] date: $date";
	$print = "Print [$user] time: $time";
	$print = $edit? "$input. $print":$print;
	$html = "
	<table width=$this->width><tr>
		<td nowrap>Up colontitul (left)</td>
...
function makeSecurityString(){
	...
	$edit = getstr('EditBy');
	$date = getstr('Updated');
	$input = "Nha�p b��i [$edit] nga�y $date";
	$print = "In b��i [$user] nga�y $time";
	$print = $edit? "$input. $print":$print;
	$version = getvar('Version');
	$html = "
	<table width=$this->width><tr>
		<td nowrap>Co�ng ty TNHH Quo�c Da�n</td>
...
function formBox(){
	...
	$table = "<table width=$this->width><tr>
		<td align=center height=35 valign=top>r1
		<td align=center valign=top>r2
		<td align=center valign=top>r3
		</table>";
